...
PreferredSizeWidget buildResponsiveAppBar(BuildContext context, int selectedIndex, Function(int) onItemSelected) {
...
Widget _buildNavItem(BuildContext context, String title, int index, int selectedIndex, Function(int) onTap) {
  return TextButton(
