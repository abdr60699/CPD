          ...
          children: [
            Image.network(
              ...
              errorBuilder: (context, error, stackTrace) =>
                  _buildYouTubeErrorWidget(), // Updated to use YouTube-specific error widget
            ),
            Center(
              child: Container(
      ...
      child: SizedBox(
        ...
        child: Stack(
          children: [
            ...
            if (propertyStatus!.isNotEmpty && propertyStatus != 'none')
              Positioned(
                top: 12,
                right: 12,
                child: Container(
                    ...
                    AnimatedBuilder(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Furnishing Status
                          if (furnishingStatus.isNotEmpty && furnishingStatus != 'none')
                          _buildDetailRow('Furnishing', furnishingStatus,
                              smallTextFontSize),
                           if ( rentAmount > 0)   
                          _buildDetailRow('Monthily Income For Rent', rentAmount.toString(),
                              smallTextFontSize),
