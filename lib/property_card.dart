...
//     final propertyId = getNumericValue('main_id', 0).toInt();
//     if (propertyId > 0) {
//       await _clickTracker.trackPropertyClick(propertyId: propertyId, clickType: 'media_gallery');
//     }
//   }
...
//     // Get property values safely - FIXED DATA ACCESS
...
//     // NEW FIELDS - Add these variable declarations
...
//                     // Purpose and Property Status badges
//                     // Row(
//                     //   children: [
//                     //     Container(
...
//                     // Updated property details with better spacing
//                     Wrap(
//                       spacing: 16, // Increased horizontal spacing
...
//                     // Updated expanded section with better spacing
//                     AnimatedBuilder(
...
//                           // Existing fields with better spacing
//                           if (builtupArea > 0)
//                             _buildDetailRow(
//                                 'Built-up Area',
...
// // Updated _buildDetailRow method with better spacing
//   Widget _buildDetailRow(String label, String value, double fontSize) {
//     return Padding(
//       padding: const EdgeInsets.only(bottom: 8), // Increased bottom padding
//       child: Row(
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
//           SizedBox(
...
//             ),
//           ),
//           const SizedBox(width: 8), // Added horizontal spacing
//           Expanded(
//             child: Text(
//               value,
//               style: TextStyle(
